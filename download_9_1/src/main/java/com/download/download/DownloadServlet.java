...
import com.download.business.User;
import com.download.data.UserIO;
import com.download.util.CookieUtil;
import com.download.business.Product;
import com.download.data.ProductIO;
...
public class DownloadServlet extends HttpServlet {
    ...
    public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException, ServletException {
        ...
        p = ProductIO.getProduct(productCode, path);
